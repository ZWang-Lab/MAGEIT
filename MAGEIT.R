MAGEIT_RAN.body = function(y.star, G.star, S.star, M, n.fix)
{
...
MAGEIT_FIX.body = function(y.star, S.star, M)
{
...
MAGEIT_RAN.C = function(y, x1, x2, e1, G, n.cov)
{
	n.fix = n.cov+2
	sub.n = dim(G)[1]
	snp.n = dim(G)[2] 
	...
	p.continuous.ran = MAGEIT_RAN.body(y.star, G.star, S.star, M, n.fix)
	return(p.continuous.ran)
}

MAGEIT_FIX.C = function(y, x1, x2, e1, G)
{
	sub.n = dim(G)[1]
	snp.n = dim(G)[2]  
	maf = colSums(G)/(sub.n*2)
	...
	p.continuous.fix = MAGEIT_FIX.body(y.star, S.star, M)
	return(p.continuous.fix)
}

MAGEIT_RAN.B = function(y, x1, x2, e1, G, n.cov)
{
 	n.fix = n.cov+2 
	sub.n = dim(G)[1]
	snp.n = dim(G)[2]  
...
MAGEIT_FIX.B = function(y, x1, x2, e1, G)
{
	sub.n = dim(G)[1]
	snp.n = dim(G)[2]  
	maf = colSums(G)/(sub.n*2)
...
MAGEIT_RAN_REAL.C = function(y, X, e1, G, n.cov)
{
	n.fix = n.cov+2
	sub.n = dim(G)[1]
	snp.n = dim(G)[2] 
...
MAGEIT_FIX_REAL.C = function(y, X, e1, G)
{
	sub.n = dim(G)[1]
	snp.n = dim(G)[2]  
	maf = colSums(G)/(sub.n*2)
...
MAGEIT_FIX_REAL.B = function(y, X, e1, G)
{
	sub.n = dim(G)[1]
	snp.n = dim(G)[2]  
	maf = colSums(G)/(sub.n*2)
...
MAGEIT_RAN_REAL.B = function(y, X, e1, G, n.cov)
{
	n.fix = n.cov+2
	sub.n = dim(G)[1]
	snp.n = dim(G)[2] 
